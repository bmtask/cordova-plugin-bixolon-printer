...
//  Model ID Define
#define	BXL_MODEL_ID_SPPR220				0x12200000        
...
#define	BXL_MODEL_ID_SPPR410				0x14100000
#define	BXL_MODEL_ID_SPPR418				0x14180000
...
#define BXL_CONNECTIONCLASS_BLE             0x0006
